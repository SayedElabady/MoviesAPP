package com.example.sayed.moviesapp.adapter;
...
import com.example.sayed.moviesapp.main.MainContract;
...
public class MainAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        imageView.setOnClickListener(view1 -> presenter.onGridItemClicked(list.get(i)));
        return view;
